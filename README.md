...
<ul>
  ...
  <li><b>오디오 장치:</b> ASIO를 지원하는 오디오 인터페이스 권장</li>
  <li><b>운영체제:</b> Windows (ASIO 활성화를 위해 <code>SD_ENABLE_ASIO="1"</code> 환경변수 사용)</li>
</ul>
...
<ol>
  ...
  <li><b>분석 시작:</b> '설정 저장 및 분석 시작' 버튼을 누릅니다. 2마디의 카운트인 이후 녹음이 시작됩니다.</li>
